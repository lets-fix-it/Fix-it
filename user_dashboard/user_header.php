			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="request.php" class=""><i class="lnr lnr-cog"></i> <span>Ask for a plumber</span></a></li>
						<li><a href="pending.php" class=""><i class="lnr lnr-cog"></i> <span>Pending requests</span></a></li>
						<li><a href="responded.php" class=""><i class="lnr lnr-cog"></i> <span>History of my requests</span></a></li>
						<li><a href="updateprofile.php" class=""><i class="lnr lnr-cog"></i> <span>Update Profile</span></a></li>
