...
<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid"><h2>Hello,  <span style="color: blue"> <?php echo $_SESSION['membername']?></span> the following are your pending case(s). They are awaiting reponse. </h2> <br />
  ...
  <table class="table table-bordered" id="members">
    ...
    <tbody>
      <?php
      $members= $connection->query("SELECT * FROM requests WHERE closed='0' && Member='".$_SESSION['membername']."'");
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Confirm the plumber's Attendance?</p>
        </div>
