...
<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid"><h2>Hello,  <span style="color: blue"> <?php echo $_SESSION['membername']?></span> the following are your pending case(s). They are awaiting your reponse. </h2> <br />
      ...
      while($row = $members->fetch_array()) {
       ?>
		...
		<td><?php echo $row['Address'];?></td>
      		...
      		<td><button type="button" data-toggle="modal" data-target="#deletemember<?php echo $row['Request_ID']?>" class="btn btn-danger">Attend</button>
      		</td>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Confirm the mechanic's Attendance?</p>
        </div>
