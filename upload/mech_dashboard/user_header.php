			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="mypending.php" class=""><i class="lnr lnr-cog"></i> <span>My Pending requests</span></a></li>
						<li><a href="history.php" class=""><i class="lnr lnr-cog"></i> <span>My History</span></a></li>
